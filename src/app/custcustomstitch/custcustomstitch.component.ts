...
@Component({
  selector: 'app-custcustomstitch',
  templateUrl: './custcustomstitch.component.html',
  styleUrls: ['./custcustomstitch.component.css']
})
export class CustcustomstitchComponent implements OnInit {
  containers=[0];
  SelectedFile: any;
  Loader: boolean;
  submitted = false;
