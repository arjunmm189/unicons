...
@Component({
  selector: 'app-machinesingle',
  templateUrl: './machinesingle.component.html',
  styleUrls: ['./machinesingle.component.css']
})
export class MachinesingleComponent implements OnInit {
  Loader: boolean;
  type: string;
  ProdList: any=[];
  User_id: any;
