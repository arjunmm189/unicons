...
@Component({
  selector: 'app-supplieruniformcustunifrmstitch',
  templateUrl: './supplieruniformcustunifrmstitch.component.html',
  styleUrls: ['./supplieruniformcustunifrmstitch.component.css']
})
export class SupplieruniformcustunifrmstitchComponent implements OnInit {
  containers=[0];
  Loader: boolean;
